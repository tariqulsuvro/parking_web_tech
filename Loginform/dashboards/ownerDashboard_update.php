    ...
    <form action="" method="POST">
        ...
        <table style="width:100%">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'GET') {
                $par_name = $_GET['p_name'];

                $cost_info_query = "SELECT * FROM cost_info WHERE parker_name = '$par_name'";
                ...
                while ($row = mysqli_fetch_assoc($cost_info)) {
                    ...
                    if ($adm == $o_uname) {
                        ...
                        $sql1 = "SELECT * from parker WHERE username = '$par_name'";
            ...
            ?>
                            <tr>
                                ...
                                <td align="center">Parking Ended</td>
                            </tr>
        ...
        <h2 class="admpanel">Parker Cost Info panel.</h2>
        <table style="width:100%">
            <thead>
                <tr>
                    <th>Cost ID</th>
            ...
            <tbody>
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'GET') {
                    ...
                    $update_date_time_query = "UPDATE cost_info SET ending_time='$date_time' WHERE parker_name = '$par_name'";
                    $update_date_time = mysqli_query($conn, $update_date_time_query);
                    if (!$update_date_time) {
                        die("Update Query Failed" . mysqli_error($conn));
                    }

                    $select_cost_info_query = "SELECT * FROM cost_info WHERE parker_name = '$par_name' AND owner_name = '$adm'";
                    $select_cost_info = mysqli_query($conn, $select_cost_info_query);
                    while ($row = mysqli_fetch_assoc($select_cost_info)) {

                        $starting_time = $row['starting_time'];
                        $ending_time = $row['ending_time'];
                    }

                    $time_query = "SELECT TIMESTAMPDIFF(MINUTE,starting_time,ending_time) AS minutes FROM cost_info";
                    ...
                    $cost_calculation = $minutes * 5;
                    $cost_calculation_query = "UPDATE cost_info SET cost='$cost_calculation' WHERE parker_name = '$par_name'";
                    $cost_calculation_execution = mysqli_query($conn, $cost_calculation_query);
                ...
                ?>
                        ...
                        <tr>
                            <td><?php echo $cost_id; ?></td>
                            <td><?php echo $owner_name; ?></td>
                            <td><?php echo $parker_id; ?></td>
                            <td><?php echo $parker_name; ?></td>
                            <td><?php echo $starting_time; ?></td>
                            <td><?php echo $ending_time; ?></td>
                            <td><?php echo $cost; ?></td>
                        </tr>
                <?php
