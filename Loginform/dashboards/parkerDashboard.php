...
session_start();
$the_p_uname = $the_p_id = "";

if (isset($_SESSION['uname'])) {
	$the_p_uname = $_SESSION['uname'];
}

if (isset($_SESSION['id'])) {
	$the_p_id = $_SESSION['id'];
}
?>
<!DOCTYPE html>
<html lang="en">
									...
									?>
										...
										while ($row = mysqli_fetch_assoc($select_query)) {
											...
											<tr>
												...
												<td><?php echo $o_division; ?></td>
												<td><?php echo $o_status; ?></td>
												<td align="center"><a href="parkerDashboard_update.php?uname=<?php echo $o_username; ?>&parker_id=<?php echo $the_p_id; ?>&parker_uname=<?php echo $the_p_uname; ?>"><button name="book_park" type="button">Book Parking</button></a></td>
											</tr>

									<?php


											// if (isset($_POST['book_park'])) {
											// 	$_SESSION['uname'] = $the_p_uname;
											// }
